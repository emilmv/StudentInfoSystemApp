...
namespace StudentInfoSystemApp.Presentation.Controllers
{
    ...
    public class AttendanceController : ControllerBase
    {
        ...
        {
            return Ok(await _attendanceService.GetAllAsync(page, searchInput, pageSize));
        }
        [HttpGet("{id}")]
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateAttendance(int id, [FromForm] AttendanceUpdateDTO attendanceUpdateDTO)
        {
